...
def main(args):
    ...
    dataset_root_dir = os.path.join("Result-Interm", args.watermarker, args.dataset, args.evade_method, args.arch)
    file_names = [f for f in os.listdir(dataset_root_dir) if ".pkl" in f]
    ...
    for idx, file_name in enumerate(file_names):
        ...
        if file_name in result_file_list:
            pass
        else:
            print("Data unprocessed - Index [{}] | File [{}]".format(idx, file_name))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--res_type", dest="res_type", type=str, default="Result-Decoded",
        help="Result-Decoded | XXX | XXX"
    )

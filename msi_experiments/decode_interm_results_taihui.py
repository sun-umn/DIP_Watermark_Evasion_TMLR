...
def main(args):
    ...
    for file_name in file_names:
        ...
        for img_idx in range(n_recon):
            ...
            img_input = format_change_of(img_bgr_uint8)

            # Step 1: Decode the interm. result
            watermark_decoded = decode_watermark_from(img_input)
            watermark_decoded_str = change_the_format_into_str(watermark_decoded)  # e.g., "10101010....", not "['10101010...']"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Specification of watermarking method. [SSL, SteganoGAN, StegaStamp]",
        default="rivaGan"
    )
    parser.add_argument(
